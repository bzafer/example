...
//		} else {
        System.out.println("Batuhannnnn zaferrrrr ");
        waitSeconds(15);
...
//		}
    ...
    @Step("Close pop-up and click akkoord button")
    public void closePopupClickaccept(){
        waitSeconds(4);
        Assert.assertTrue("Frame did not find",isDisplayBy(By.cssSelector("iframe[class='r42CookieBar']")));
           driver.switchTo().frame(driver.findElement(By.cssSelector("iframe[class='r42CookieBar']")));
        Assert.assertTrue("Element was not display",isDisplayBy(By.cssSelector("a[class='button accept']")));
           driver.findElement(By.cssSelector("a[class='button accept']")).click();
           waitSeconds(1);
...
@Step("Select rondom product")
    ...
    List<WebElement> lastNewsTitle = driver.findElements(By.cssSelector("div[class='pro-product-image-wrapper']"));
    ...
    @Step("Select random trial product")
    public void selectRondomtrialProduct(){
        waitSeconds(2);
        List<WebElement> lastNewsTitle = driver.findElements(By.cssSelector("button[class='btn primary_button primary-button btn-block btn-lg pro-action-add-to-basket-as-sample']"));
        WebElement randomNewstrial = (WebElement) getRandomContent(lastNewsTitle);
        scrollToElement(randomNewstrial);
        //hoverToElement(randomNews);
        waitSeconds(1);
        javaScriptClicker(driver,randomNewstrial);
        waitSeconds(1);
       // randomNewstrial.click();
        System.out.println("Click on the random trial product");
        List<WebElement> lastNewsTitle2 = driver.findElements(By.cssSelector("button[class='btn primary_button primary-button btn-block btn-lg pro-action-add-to-basket-as-sample']"));
        WebElement randomNewstrial2 = (WebElement) getRandomContent(lastNewsTitle);
        scrollToElement(randomNewstrial2);
        //hoverToElement(randomNews);
        waitSeconds(1);
        javaScriptClicker(driver,randomNewstrial2);
